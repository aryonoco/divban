...
All code was reviewed, tested, and iterated on by me. The design choices (Effect for typed errors and resource management, service abstraction patterns, etc.) are mine. The TypeScript syntax is not.
